...
const Navbar = () => {
    ...
    return (
        <nav className={`sticky top-0 z-50 py-6 bg-white border-b border-neutral-700/80 ${!isWelcomePage ? 'mb-8' : ''}`}>
            <div className="container px-6 mx-auto relative text-sm">
                <div className={`flex items-center ${isWelcomePage ? 'justify-center' : 'justify-between'}`}>
